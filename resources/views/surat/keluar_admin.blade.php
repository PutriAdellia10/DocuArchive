            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $surat->tanggal_pembuatan }}</td>
                        <td>{{ $surat->judul_surat }}</td>
                        <td>{{ optional($surat->pengguna)->jabatan }}</td>
                        <td>{{ $surat->status_pengiriman }}</td>
                        <td>
                            <a href="{{ route('surat-keluar.show', $surat->id) }}" class="btn btn-info">Lihat</a>
                            <a href="{{ route('surat-keluar.edit', $surat->id) }}" class="btn btn-warning">Edit</a>
