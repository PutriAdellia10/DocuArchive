...
<div class="modal" id="modalEdit">
    <div class="modal-content">
        <h3 id="modalTitle">Edit Surat Keluar</h3>
        <form id="modalFormEdit" action="{{ route('surat.keluar.update', $surat->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group">
...
<script>
    ...
    form.action = `/surat-keluar/${surat.id}`; // Adjust this URL to your update route

    // Populate the modal fields with the surat data
    document.getElementById('edit_no_agenda').value = surat.no_agenda;
    document.getElementById('edit_tanggal').value = surat.tanggal;
    document.getElementById('edit_id_asal_surat').value = surat.id_asal_surat;
    ...
    document.getElementById('edit_konten').value = surat.konten;
    document.getElementById('edit_id_sifat_surat').value = surat.id_sifat_surat;
    document.getElementById('edit_status').value = surat.status;
